...
// Koordinaten-Overlay (SOLVE_THRESHOLD = 23), Toast-Feedback
...
// ANZAHL DER SONGS ZUM LÖSEN (23 von 25 nötig)
const SOLVE_THRESHOLD = 23;
...
// ---------------------------------------------------------------------------
// 3. Song-Label-Bezeichner (1–25)
// ---------------------------------------------------------------------------

/**
 * Gibt die Song-Nummer als Label zurück: 1→"1", 2→"2", … 25→"25"
