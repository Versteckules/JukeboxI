...
- **Mehrsprachig (Deutsch / Englisch / Tschechisch)**: Dynamischer Sprachwechsel (DE / EN / CS) für alle UI-Elemente und Feedback-Toasts.
...
│   ├── i18n.js          # Übersetzungen (DE/EN/CS) & Sprachwechsel
