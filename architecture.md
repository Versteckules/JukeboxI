...
**Sprache:** Dreisprachig DE/EN/CS (umschaltbar per Toggle-Button)
...
│   ├── i18n.js         # Übersetzungen DE/EN/CS, Sprachumschalt-Logik
...
const I18N = {
  ...
  cs: { title: "Projekt Jukebox", solved: "Vyřešeno!", ... }
};
```
- Toggle-Button oben rechts: Zyklischer Wechsel 🇩🇪 DE → 🇬🇧 EN → 🇨🇿 CZ
